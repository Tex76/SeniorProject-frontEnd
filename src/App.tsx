...
function App() {
  ...
  const [favouriteActivities, setFavouriteActivities] = React.useState<string[]>([]);
  ...
  return (
    <UserContextProvider>
      <Router>
        ...
        <FavouriteActivitiesContext.Provider value={{ favouriteActivities, setFavouriteActivities }}>
          <Routes>
