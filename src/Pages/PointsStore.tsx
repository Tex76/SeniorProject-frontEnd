import { Box, Button, Card, CardContent, CardMedia, Container, Grid, IconButton, Typography, Dialog, DialogTitle, DialogContent } from '@mui/material';
            ...
            <Grid container spacing={2}>
              ...
              <CardContent>
                ...
                <Box display="flex" justifyContent="center" alignItems="center">
                  <IconButton onClick={() => handleQuantityChange(index, -1)} disabled={quantities[index] <= 1}>
                    <RemoveIcon />
                  </IconButton>
                  ...
                  <IconButton onClick={() => handleQuantityChange(index, 1)}>
                    <AddIcon />
                      ...
                      <Button variant="contained" color="primary" sx={{ mt: 2 }} onClick={() => handlePurchase(index)}>
                        {item.price} points
                      </Button>
                    </CardContent>
                  </Card>
        ...
        {tabValue === 1 && (
          <Box sx={{ flexGrow: 1, m: 2 }}>
            {purchasedVouchers.map((voucher, index) => (
              <Card sx={{ maxWidth: 512, maxHeight: 512, mb: 2 }} key={index} onClick={() => handleVoucherClick(voucher)}>
                <CardContent>
