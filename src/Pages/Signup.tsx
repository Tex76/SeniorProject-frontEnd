                  ...
                  endAdornment: (
                    <InputAdornment position="end">
                      <IconButton
                        ...
                        onClick={(event: React.MouseEvent<HTMLButtonElement>) => handleClickShowPassword(event)} // Pass the event argument
                        onMouseDown={(event: React.MouseEvent<HTMLButtonElement>) => event.preventDefault()} // prevent the mousedown event from triggering form submission
                        edge="end"
                      >
