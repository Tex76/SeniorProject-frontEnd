...
import { Typography, Box, Card, CardContent, IconButton, CardMedia, Rating, useMediaQuery, useTheme } from '@mui/material';
...
const PopularPlacesCards = () => {
  ...
  const cards = [
    { id: 1, name: 'Haus Restaurant & Lounge', rating: 4.4, category: 'Restaurant', text: 'Things to eat', image: cardImg1 },
    { id: 2, name: 'Sheikh Salman Bin Ahmed Al Fateh Fort', rating: 4.1, category: 'Ancient Ruins', text: 'Things to do', image: cardImg2 },
    { id: 3, name: 'Tree Of Life', rating: 4.5, category: 'Landmark', text: 'Things to do', image: cardImg3 },
    { id: 4, name: 'Hilton Bahrain', rating: 4.6, category: 'Hotel', text: 'Places to Stay', image: cardImg4 },
  ];
  ...
  return (
    <Box>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <Box ref={scrollContainerRef} sx={{ overflowX: 'auto', display: 'flex' }}>
          {cards.map((card) => (
