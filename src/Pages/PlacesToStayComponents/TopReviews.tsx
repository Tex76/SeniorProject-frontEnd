...
const TopReviews = () => {
  ...
  return (
    <div>
      ...
      {value === 0 &&
                  <>
                  <Typography variant="h4" sx={{ fontWeight: 'bold', textAlign: 'center' }}>Top reviews</Typography>
                  <CardContent sx={{ position: 'relative', borderTop: '2px solid black',borderBlockColor:'gainsboro' ,margin: '30px', backgroundColor: 'oldlace', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
  <Box sx={{ display:'flex',width:'100%',justifyContent:'end'}}>
  <Box sx={{ margin:'10px',display: 'flex', backgroundColor:'white', width:'100px',height:'50px', borderRadius:'50px', border: '1px solid black' }}>
  ...
  <Typography variant="caption">
    <Box component="span" sx={{ fontWeight: 'bold' }}>14</Box> contributions
  </Typography>
  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <Typography variant="subtitle1">Adventure </Typography>
   <img src={Adventure} alt="Adventure" style={{ width: '20px', height: 'auto',marginLeft:'10px' }}/>
</div>
</Box>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
                    ...
                    <Box >
    <Typography variant="h5" sx={{fontWeight: 'bold'}}>Title of your review for this place</Typography>
    <Box display="flex" alignItems="center" mt={1} mb={2}>
      <Typography variant="overline">Written March 16, 2024</Typography>
    ...
    <Box mt={2}>
      <Typography variant="body1"><strong>Date visited:</strong> March 2024</Typography>
    </Box>
  ...
  <Typography variant="subtitle1">Adventure </Typography>
   <img src={Adventure} alt="Adventure" style={{ width: '20px', height: 'auto',marginLeft:'10px' }}/>
                    ...
                    <Box>
                      ...
                      <Typography variant="body1"sx={{fontWeight:'bold'}}>Date: Mar 5, 2023</Typography>
                      </Box>
